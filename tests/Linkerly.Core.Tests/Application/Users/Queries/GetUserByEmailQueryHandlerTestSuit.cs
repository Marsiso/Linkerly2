...
public class GetUserByEmailQueryHandlerTestSuit
{
    [Fact]
    public void Handle_WhenEntityExists_ThenReturnValue()
    {
        ...
        var queryHandler = new GetUserByEmailQueryHandler(databaseContext);
        var query = new GetUserByEmailQuery(userSample.Email);
