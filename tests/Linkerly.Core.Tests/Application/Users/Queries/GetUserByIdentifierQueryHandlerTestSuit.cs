...
public class GetUserByIdentifierQueryHandlerTestSuit
{
    [Fact]
    public void Handle_WhenEntityExists_ThenReturnValue()
    {
        ...
        var queryHandler = new GetUserByIdentifierQueryHandler(databaseContext);
        var query = new GetUserByIdentifierQuery(userSample.Identifier);
